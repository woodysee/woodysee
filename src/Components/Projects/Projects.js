      ...
      <div className="projects">
        ...
        <div className="row projects-grid">
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
            ...
            < p className = "project-description">Enables shoppers to tap on the burgeoning travellers network to get their favourite brands and unique items, from all over the world.</p>
            <div className="project-role">Incremental development of the website and backend with the UX and product teams</div>
            <a className="project-contact-link" href="https://www.airfrov.com">Live</a>
          </div>
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
            <img className="project-img project-frizzy"/>
            <h3 className="project-title">Frizzy</h3>
            < p className = "project-description">Reusable UI component library
            for web pages.</p>
            <div className="project-role">Developer</div>
            <a className="project-contact-link" href="https://www.npmjs.com/package/frizzy">Distribution</a>
            <a className="project-contact-link" href="https://staging.airfrov.com/frizzy/demo">Demo</a>
          </div>
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
          ...
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
            ...
            <a className="project-contact-link" href="http://swapbooks.woodysee.com">Live</a>
          </div>
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
