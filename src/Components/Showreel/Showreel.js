        ...
        <div className="row projects-grid">
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
            ...
            <p className="project-description">
              Opening video of SMU Convocation 2012 Pre-formal Showcase
            </p>
          ...
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
            ...
            <p className="project-description">
              A young man's visit to the toilet takes him outside his comfort
              zone.
            </p>
          ...
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
            ...
            <p className="project-description">
              This video is made to document the preliminary auditions of the
              Voice Pesonality Hunt, a university-wide stage hosting competition
              in Singapore Management University.
            </p>
            <div className="project-role">
              Production, camera, editing & title design
            </div>
          </div>
          {/* /.project */}
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 project">
            ...
            <p className="project-description">
              In the midst of a zombie outbreak occurring right before final
              examinations, four best friends attempt to survive, discovering
              the truth about the nature of the outbreak and that they may just
              have the power to save the school.
            </p>
